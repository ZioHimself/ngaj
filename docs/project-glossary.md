...
- **Setup Container**: Pre-built Docker image (`ziohimself/ngaj-setup:stable`) containing the Node.js setup wizard. Runs temporarily during installation, then destroyed. Credentials persist on host via volume mount.
